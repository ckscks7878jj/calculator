...
public class ArithmeticCalculator { // 제네릭 활용

    private List<Double> results = new ArrayList<>(); // 연산 결과들을 저장하는 리스트
    ...
    public List<Double> getResults() { // 게터 메서드
        return results; // 컬렉션 리스트를 반환
    }

    public void setResults(List<Double> results) { // 세터 메서드
